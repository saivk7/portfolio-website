...
const TerminalFeature = () =>{
    ...
    var Typer={
        ...
        init: function(){// inizialize Hacker Typer
            var accessCountimer=setInterval(function(){Typer.updLstChr();},500); // inizialize timer for blinking cursor
    ...
    function replaceUrls(text) {
        ...
        Typer.speed = 3;
        var myvar = '<span id="a">jeff@weisbein</span>:<span id="b">~</span><span id="c">$</span> cat jeffweisbein.txt<br/><br/>'+
